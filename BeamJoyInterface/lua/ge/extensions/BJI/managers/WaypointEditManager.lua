local M = {
    _startColor = ShapeDrawer.Color(1, 1, 0, 0.9),
    _wpColor = ShapeDrawer.Color(.66, .66, 1, 0.9),
    _segmentColor = ShapeDrawer.Color(1, 1, 1, 0.9),
    _textColor = ShapeDrawer.Color(1, 1, 1, 1),
    _textBgColor = ShapeDrawer.Color(0, 0, 0, 0.9),
